#ifndef _IntegUnpolDrellYan_WC_hh_
#define _IntegUnpolDrellYan_WC_hh_
...
namespace IntegUnpolDrellYan {
  ...
  DEF_COF( CQQLO )
  DEF_COF( CQQNLO )
  DEF_COF( CGQNLO ) // qgnlo = gqnlo // NO!!!
  DEF_COF( CQGNLO ) // qgnlo != gqnlo
...
//for Unpolarized Drell-Yan x * z * d sigma
...
/* INCORRECT!! QGNLO (Q-G exchange) implementation 
// have to consider interchange of convPDFs or params ... etc.
template< class DD >
DD CQGNLO::SWC( const DD& x, const DD& z ) {
  return (*cb_)( z, x );
}
...
#endif //  _IntegUnpolDrellYan_WC_hh_
