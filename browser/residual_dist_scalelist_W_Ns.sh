...
[ ! -e "./dist_residual_scalelist_W_Ns" ] && mkdir -p ./dist_residual_scalelist_W_Ns
cd dist_residual_scalelist_W_Ns
...
#Q2LIST="0.41 0.84 1 1.19 1.41 1.68"
##Q2LIST="0.41 0.5 0.71 0.84 1 1.19 1.41 1.68"
##Q2LIST="0.35 0.41 0.5 0.71 0.84 1 1.19 1.41 1.68"
##Q2LIST="0.3 0.5 0.71 0.84 1 1.19 1.41 2"
##Q2LIST="0.5 0.71 0.84 1 1.19 1.41"
...
#for FFSCALEDIR in FF_FULL_MultConstNf_W_Ns_SCALE_W_NORM_3
#for FFSCALEDIR in FF_FULL_MultConstNf_W_Ns_SCALE FF_FULL_MultConstNf_W_Ns_SCALE_W_NORM_3
#for FFSCALEDIR in FF_FULL_MultConstNf_W_Ns_SCALE_W_NORM_cdef
do
for SCALE in ${Q2LIST}
do
