#ifndef _Fitting_MultiFrag_A1hFitLM_hh_
#define _Fitting_MultiFrag_A1hFitLM_hh_
...
namespace Fit{
  ...
  class MultiFrag_A1hFitLM : public MultiFragFit  {
  public:
    
    //< a constructor
    MultiFrag_A1hFitLM( Utility::Arguments& args ) throw( int );
    virtual ~MultiFrag_A1hFitLM();             //!< a destructor
  ...
  protected:
    ...
    */
    ...
    void ppost_config_process() throw( int );    
  ...
  private:
    ...
    */
    ...
    //! output filename
    std::string tfname_; // for chi2_MultiFrag vs chi2_A1h

    //! store pointer to A1hFit obj
    A1hFit* a1hfit_;

    std::string ffname_;

    void dist_manip_process();
...
#endif // _Fitting_MultiFrag_A1hFitLM_hh_
