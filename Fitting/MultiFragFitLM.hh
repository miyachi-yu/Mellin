#ifndef _Fitting_MultiFragFitLM_hh_
#define _Fitting_MultiFragFitLM_hh_
...
namespace Fit{
  ...
  class MultiFragFitLM : public MultiFragFit  {
  public:
    
    //< a constructor
    MultiFragFitLM( Utility::Arguments& args ) throw( int );
    virtual ~MultiFragFitLM();             //!< a destructor
...
#endif // _Fitting_MultiFragFitLM_hh_
