...
MultiFragFitLM::MultiFragFitLM( Arguments& args ) throw( int ) : 
...
void MultiFragFitLM::ppost_config_process(){
  ...
  if( ! args.hasOpt( "Minuit" ) ){
    ...
    ARG_LOG 
      << "--- command set in MultiFragFitLM ---" << endl;
    ARG_LOG 
...
void MultiFragFitLM::defineParameters(){
...
void MultiFragFitLM::dumpParameters(){
...
double MultiFragFitLM::referenceFunction(){
...
void MultiFragFitLM::chi2err_calc(){
...
void MultiFragFitLM::chi2err_out( ostream& os, 
...
void MultiFragFitLM::param_out( std::ostream& os ){
...
void MultiFragFitLM::param_corr_out( std::ostream& os ){
...
bool MultiFragFitLM::postFit_summary( std::ostream& os ){
...
void MultiFragFitLM::mirror( const std::vector< QCD::Parameter >& par ){
...
void MultiFragFitLM::mirror( const int& n, double* par ){
...
void MultiFragFitLM::mxcreation(){
...
void MultiFragFitLM::matrix_output(){
...
//PdfErrMatrix& MultiFragFitLM::createErrMx(){
PdfErrMatrix MultiFragFitLM::createErrMx(){
...
void MultiFragFitLM::seteigparams(){

  // constructed only with free parameters
  eigparams_.resize( fpindx_[ 0 ].size() + fpindx_[ 1 ].size(), 
		     QCD::Parameter() );
...
void MultiFragFitLM::setweights(){
...
double MultiFragFitLM::geteigvvalue( const int& i ){
