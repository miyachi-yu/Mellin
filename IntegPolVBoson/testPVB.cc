...
int main( int argc, char* argv[] ) {
  ...
  try {
    ...
    IntegPolVBoson::StrFunc dcs( args, IntegXsec::Charge::p, 
    ...
    IntegPolVBoson::nStrFunc dcsnx( args, IntegXsec::Charge::p,
				      QCD::Flavor::PRp );
    //    /*
    ...
    //    */
    /*
    dcsnx.xsecComp()->coeff()->constNf( true );
    dynamic_cast< polPDF::Evo* >
      ( dcsnx.xsecComp()->vevo()[ 0 ] )->constNf( true );
    dynamic_cast< polPDF::Evo* >
      ( dcsnx.xsecComp()->vevo()[ 1 ] )->constNf( true );
    */
